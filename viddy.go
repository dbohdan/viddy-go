...
var helpTemplate = `Press ESC or q to go back
 ...
 [::b]Key Bindings[-:-:-]
   ...
   Go further into the past   : [yellow]{{ .GoToMorePast }}[-:-:-]
   Go further into the future : [yellow]{{ .GoToMoreFuture }}[-:-:-]
   Go to oldest position      : [yellow]{{ .GoToOldest }}[-:-:-]
   Go to current position     : [yellow]{{ .GoToNow }}[-:-:-]
`
